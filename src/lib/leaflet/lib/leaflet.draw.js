...
L.drawVersion = "1.0.4";
  ...
  L.drawLocal = {
    ...
    edit: {
      toolbar: {
        ...
        buttons: {
          edit: '编辑图形',
          editDisabled: '没有图形可供编辑',
          remove: '删除图形',
          removeDisabled: '没有图形可删除'
        }
      },
      handlers: {
        edit: {
  ...
  L.Draw.Polygon = L.Draw.Polyline.extend({
    ...
    options: {
      ...
      precision: {km: 2, ha: 2, m: 0, mi: 2, ac: 2, yd: 0, ft: 0, nm: 2}
    },
  ...
  L.Draw.Rectangle = L.Draw.SimpleShape.extend({
    ...
    options: {
      ...
      metric: ['km', 'm'] // Whether to use the metric measurement system or imperial
    },
