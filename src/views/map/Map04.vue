...
export default defineComponent({
    ...
    setup () {
        ...
        function drow () {
            ...
            // 线
            L.polyline([[30.52247, 114.39332], [30.5209, 114.39332]], {
                // 线颜色
                color: 'blue'
            }).addTo(map)
            // 绘制矩形
            L.rectangle([[30.52172, 114.39359], [30.52153, 114.39428]], {
                // 颜色
                color: '#ff7800',
                // 线宽
                weight: 1,
            ...
            // 绘制多边形
            L.polygon([[30.52263, 114.39445], [30.52215, 114.39406], [30.52215, 114.39477]], {
                // 颜色
                color: 'red'
            }).addTo(map)
        }
