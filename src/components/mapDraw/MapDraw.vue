...
export default defineComponent({
    ...
    setup() {
            ...
            case 'polyline': {
                if (drawLayer.editing.latlngs[0].length > 0) {
                    for (
                        let latlngslength = 0;
                        latlngslength <
                                drawLayer.editing.latlngs[0].length;
                        latlngslength++
                    ) {
                        console.log(
                            drawLayer.editing.latlngs[0][latlngslength]
                                .lat +
                                        ',' +
                                        drawLayer.editing.latlngs[0][
                                            latlngslength
                                        ].lng
                        )
                    }
        ...
        function edit() {
            ...
            if (
                drawLayerGrounp &&
                    Object.keys(drawLayerGrounp._layers).length !== 0
            ) {
