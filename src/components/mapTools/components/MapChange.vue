<template>
    <div class='item'>
        ...
        <div class='btn'>
            <el-radio v-model='mapType' label='GaoNormal' border>高德地图</el-radio>
            <el-radio v-model='mapType' label='GaoDeImage' border>高德卫星</el-radio>
            <el-radio v-model='mapType' label='TianNormal' border>天地图</el-radio>
            <el-radio v-model='mapType' label='TianImage' border>天地图卫星</el-radio>
            <el-radio v-model='mapType' label='TianTerrain' border>天地图地形</el-radio>
            <el-radio v-model='mapType' label='OSM' border>OSM地图</el-radio>
            <el-radio v-model='mapType' label='GeoNormal' border>智图</el-radio>
            <el-radio v-model='mapType' label='GeoNormal1' border>智图深色</el-radio>
        </div>
    </div>
</template>
