module.exports = {
    ...
    rules: {
        ...
        // 'no-console': import.meta.env.VITE_APP_CURRENTMODE === 'production' ? 'warn' : 'off', // 是否使用 console
        ...
        'keyword-spacing': 'error', // return throw case后面要不要加空格
        'space-unary-ops': [
            'off',
            {
                words: true,
